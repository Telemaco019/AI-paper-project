...
//              chartSeries.remove(items.objs[i]);
        ...
        //now we init the chartSeries and then put back the saved objects only.
        chartSeries.clear();
