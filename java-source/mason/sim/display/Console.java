...
public class Console extends JFrame implements Controller
    ...
    void startSimulation()
        {
        removeAllInspectors(true);      // init inspectors
        setRandomNumberGenerator(randomSeed);
        simulation.start();
        ...
        // no need to init out the global inspector.  It stays.
...
//                    int numSteps = 1;
    ...
    /** Simulations can call this to init out the "Display list" of the console */
